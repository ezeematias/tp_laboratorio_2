...
namespace Library
{
    public sealed class Attendance : Device
    {
        ...
        /// <param name="typeDevice">Type for the device</param>
        /// <param name="eValidation">Validation for the device</param>
        public Attendance(double serialNumber, ECode codeInternal, EType typeDevice, EValidation eValidation) : base(serialNumber, codeInternal, typeDevice, eValidation)
        {
            AddComponent(eValidation);
        }
